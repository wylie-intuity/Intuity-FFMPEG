...
#define FFMPEG_CONFIGURATION "--prefix=/usr/local/ffmpeg-debug --arch=arm64 --enable-gpl --enable-libx264 --enable-debug=3 --disable-optimizations --disable-stripping --extra-cflags='-fno-omit-frame-pointer -O0 -g' --extra-ldflags=-g --enable-shared"
#define FFMPEG_LICENSE "GPL version 2 or later"
#define CONFIG_THIS_YEAR 2025
#define FFMPEG_DATADIR "/usr/local/ffmpeg-debug/share/ffmpeg"
#define AVCONV_DATADIR "/usr/local/ffmpeg-debug/share/ffmpeg"
