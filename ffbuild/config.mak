...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/usr/local/ffmpeg-debug --arch=arm64 --enable-gpl --enable-libx264 --enable-debug=3 --disable-optimizations --disable-stripping --extra-cflags='-fno-omit-frame-pointer -O0 -g' --extra-ldflags=-g --enable-shared
...
WINDRES=windres
DOXYGEN=doxygen
LDFLAGS= -g  -Wl,-dynamic,-search_paths_first -Qunused-arguments
LDEXEFLAGS=
LDSOFLAGS=
...
EXTRALIBS-avfilter=-framework OpenGL -framework OpenGL -pthread -lm -framework VideoToolbox -framework CoreImage -framework AppKit -framework CoreFoundation -framework CoreMedia -framework CoreVideo -framework CoreServices
